...
def export_daily_outcomes(
    ...
    for ticker, candidate in candidates.items():
        ...
        row = {
            ...
            "reachable_metric_count": candidate.get("reachable_metric_count"),
            "unavailable_metrics": "|".join(candidate.get("unavailable_metrics", [])),
            "benchmark_symbol": candidate.get("benchmark_symbol"),
            "alpha12_total_score": candidate.get("alpha12_total_score"),
            "alpha12_score_pct": candidate.get("alpha12_score_pct"),
            "rubric_version": candidate.get("rubric_version"),

...
def main() -> None:
    ...
    result = run_multi_day_trainer(client, args.tickers, dates, cache_root=args.cache, output_root=args.output_root, threshold_pct=args.threshold_pct, resume=not args.no_resume)
